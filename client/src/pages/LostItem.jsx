...
import { LostItems, User } from '../assets/assets';
...
const LostItem = () => {
  ...
  return (
    <div className="bg-light min-h-screen flex flex-col">
      ...
      <section className="px-2 const currentItems = filteredItems.slice(0, (currentPage + 1) * itemsPerPage); md:px-0 flex justify-center">
        <div className="bg-white/40 backdrop-blur-lg rounded-2xl shadow-xl p-4 md:p-6 w-full max-w-4xl border border-white/30 transition-all">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3 items-center">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="flex-shrink-0 text-gray-500 hover:text-red-500 text-sm font-medium underline transition-colors flex items-center gap-1 pr-10"
              >
      ...
      <main className="flex-grow w-full flex flex-col items-center">
        {currentItems.length > 0 ? (
          ...
          <p className="text-gray-500 text-center py-10 flex-grow">No lost items found.</p>
        )}
